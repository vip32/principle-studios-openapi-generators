...
{ 
    public abstract class TreeControllerBase : global::Microsoft.AspNetCore.Mvc.ControllerBase
    {
        
        [global::Microsoft.AspNetCore.Mvc.HttpPost]
        [global::Microsoft.AspNetCore.Mvc.Route("/tree")]
        // A tree
        [global::Microsoft.AspNetCore.Mvc.ProducesResponseType(200, Type = typeof(Node))] // application/json
        public async global::System.Threading.Tasks.Task<global::Microsoft.AspNetCore.Mvc.IActionResult> GetTreeTypeSafeEntry(
            
        ) => (await GetTree()).ActionResult;

        protected abstract global::System.Threading.Tasks.Task<GetTreeActionResult> GetTree();

        public readonly struct GetTreeActionResult
        {
            ...
            private GetTreeActionResult(global::Microsoft.AspNetCore.Mvc.IActionResult ActionResult, global::System.Collections.Generic.KeyValuePair<string, string>[] headers)
            {
                this.ActionResult = new HeaderActionResult(ActionResult, headers);
            }

            private GetTreeActionResult(int statusCode, params global::System.Collections.Generic.KeyValuePair<string, string>[] headers)
                : this(new global::Microsoft.AspNetCore.Mvc.StatusCodeResult(statusCode), headers)
            {
            }

            private GetTreeActionResult(int statusCode, string mediaType, global::System.Type declaredType, object? resultObject, params global::System.Collections.Generic.KeyValuePair<string, string>[] headers)
            ...
            /// A tree
            /// </summary>
            public static GetTreeActionResult Ok(Node result) =>
                new GetTreeActionResult(200, "application/json", typeof(Node), result);
            

            /// <summary>Allows for action results not specified in the API</summary>
            public static GetTreeActionResult Unsafe(global::Microsoft.AspNetCore.Mvc.IActionResult actionResult, params global::System.Collections.Generic.KeyValuePair<string, string>[] headers) =>
                new GetTreeActionResult(actionResult, headers);
        }
    }
}